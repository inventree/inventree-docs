...
[#1598](https://github.com/inventree/InvenTree/pull/1598), [#1605](https://github.com/inventree/InvenTree/pull/1605) and [#1608](https://github.com/inventree/InvenTree/pull/1608) add support for automatically updating currency conversion rates. For more information refer to the [pricing documentation](../../part/pricing).
